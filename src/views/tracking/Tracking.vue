    ...
    <base-header type="info">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Tracking</h6>
      ...
      <div class="col">
        <ul class="nav nav-tabs" id="profile-tab" role="tablist">
          <template v-for="(route, index) in TrackingRoutes.children">
            <li
...
class Tracking extends Vue {
  activeTab: number | null = 0;
  showModal: boolean = false;
  routes: RouteConfig = TrackingRoutes;
  formErrors: any = {};
  formInputs: any = {};
