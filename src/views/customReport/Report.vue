    ...
    <base-header type="info">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Custom Report</h6>
      ...
      <div class="col">
        <ul class="nav nav-tabs" id="profile-tab" role="tablist">
          <template v-for="(route, index) in CustomReportRoutes.children">
            <li v-bind:key="route.name" class="nav-item">
              <router-link :to="$router.resolve({name:route.name}).location">
                <span
...
class Report extends Vue {
  ...
  routes: RouteConfig = CustomReportRoutes;
  formErrors: any = {};
  formInputs: any = {};

  get CustomReportRoutes() {
    return CustomReportRoutes;
  }
