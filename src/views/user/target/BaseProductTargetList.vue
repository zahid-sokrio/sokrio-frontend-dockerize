      ...
      <div class="row">
        <div class="col-6">
          <div class="form-inline">
            <h3 class="mb-0">Base Product Targets</h3>
...
export default class TargetList extends Mixins(TaxonomyMixin) {
  ...
  async fetchTarget() {
    ...
    let url = isFirstPage
      ? `/targets?${this.queryBuilder.getFilters()}&is_bulk=bulk`
      : `/targets?${this.queryBuilder.getFilters()}&page=${this.pagination.currentPage}&is_bulk=bulk`;
