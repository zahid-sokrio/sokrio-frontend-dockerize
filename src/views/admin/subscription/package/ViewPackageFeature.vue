<template>
    <modal :show="isActive" @close="close">
            ...
            >
                <!--Header-->
                <h4 slot="header" class="text-uppercase ls-1 text-primary py-3 mb-0">{{currentPackage.name}}</h4>

                <!--Body-->
                <span class=" text-muted">Trial days: {{currentPackage.trial_days}} days</span>
