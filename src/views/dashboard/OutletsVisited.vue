      ...
      <div class="col-xl-6 col-md-6">
        <card>
          <template slot="header">
            <!-- Subtitle -->
            <h6 class="surtitle">Outlets</h6>
            <div class="form-inline justify-content-between">
              <!-- Title -->
              <h5 class="h3 mb-0">Avg. Daily outlet visit</h5>
          ...
          <div class="cardStyle" v-if="selectedGraph == 'absolute number'">
            <a href="#" @click.prevent="expandState('overAllCountry')" v-if="!previousRegion">
              <dashboard-stats-card title="Avg. Daily outlet visit" type="gradient-green" sub-title="24" icon="ni ni-money-coins">
      ...
      <div class="col-xl-6 col-md-6">
        <card>
          <template slot="header">
            ...
            <h6 class="surtitle">Outlets</h6>
            <!-- Title -->
            <h5 class="h3 mb-0">Outlet visit target vs achievement</h5>
          </template>
          <div class="cardStyle">
...
export default class OutletsVisited extends Mixins(PaginationComponentMixin) {
