<template>
  <div class="col-xl-3 col-md-6 ">
    <dashboard-stats-card
      ...
      :title="'Avg ' + getTaxonomy('order') + ' Items'"
      icon="ni ni-app"
      type="gradient-info"
      :not-loading="!loading"
    >
...
export default class LinePerCallOrder extends Mixins(TaxonomyMixin) {
  @Prop({ default: '' })
  ...
  async fetch() {
    ...
    try {
      ...
      this.result = data.dailyReports.linePerCallOrder;
    } finally {
      // catch (e) {
      //
      // }
