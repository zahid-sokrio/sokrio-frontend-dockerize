...
export default class AverageInvoice extends Mixins(TaxonomyMixin) {
  @Prop({default: ''})
  ...
  async fetch(){
    ...
    try {
      ...
      this.result = data.dailyReports.avgInvoice.toLocaleString('en-US');
    }
      // catch (e) {
      //
      // }
