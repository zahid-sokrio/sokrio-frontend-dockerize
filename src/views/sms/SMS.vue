    ...
    <base-header type="info">
      ...
      <div class="col">
        <ul class="nav nav-tabs" id="profile-tab" role="tablist">
          <template v-for="(route, index) in SMSRoutes.children">
            <li v-bind:key="route.path" class="nav-item" @click="setCurrentTab(index)" v-can="route.meta.permission">
              <router-link :to="route.path">
                <span class="nav-link tab-link" :class="{ active: activeTab == index }" data-toggle="tab" role="tab" aria-controls="">
