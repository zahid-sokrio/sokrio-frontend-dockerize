<template>
  <div class="card">
    ...
    <div class="card-body">
      <div v-if="$route.name == 'system-report'" class="row pl-3">
      ...
      <router-view name="SystemReport"></router-view>
    </div>
  </div>
</template>
<script lang="ts">
  ...
  private reports: any[] = [
    {
      ...
      tooltip: 'Active User Report.',
      permission: PermissionEnum.ACTIVE_USER_REPORT,
