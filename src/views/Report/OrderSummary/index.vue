    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <TerritoryAutocomplete :disabled="!selectedTerritoryType" label="Territory" :collapseTags="true"
            ...
            <div v-if="downloadbtn" class="w-100">
                ...
                <div class="text-center col-12">
                    ...
                    <div class="col-8 offset-4" v-if="totalRecords > 0">
                        ...
                        <download-excel :fetch="exportSummary" :before-generate="() => { excelType = 'csv' }" :name="fileName"
                            :meta="json_meta" type="csv" :fields="json_fields" style="float: left;">
